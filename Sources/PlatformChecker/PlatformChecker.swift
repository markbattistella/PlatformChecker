...
extension PlatformCheck {
  ...
  ///
  /// This method checks the app's receipt location. TestFlight builds use a sandbox receipt.
  ///
  /// - Returns: `true` if the app is running through TestFlight, otherwise `false`.
  static var isTestFlight: Bool {
    guard let receiptURL = Bundle.main.appStoreReceiptURL else { return false }
    return isTestFlightReceiptURL(receiptURL)
  }

  /// Returns whether an App Store receipt URL represents a TestFlight receipt.
  static func isTestFlightReceiptURL(_ receiptURL: URL) -> Bool {
...
extension Bundle {
  ...
  fileprivate var isLiquidGlassDisabled: Bool {
...
public enum LiquidGlassStatus: Equatable, Sendable {
